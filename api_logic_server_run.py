...
#
#    (v 14.05.01, May 17, 2025 19:35:26)
#
...
api_logic_server__version = '14.05.01'
api_logic_server_created__on = 'May 17, 2025 19:35:26'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 14.05.01\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 14.05.01\n'
    msg += f'.. startup message: {start_up_message}\n'
